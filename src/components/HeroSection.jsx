  ...
  />
      ...
      <div style={{zIndex:30,position:'relative',width:'100%'}}>
        <h1 className="hero-heading"
          style={{ fontFamily: 'Valky, serif' }}

        >Conquer the Jungle</h1>
        <div className="hero-subheading">
          A tour or cruise of the Amazon Rainforest is a sublime journey into the heart of the most biodiverse <br /> place on the planet. Amazon lodges, such as La Selva Lodge in Ecuador.
        </div>
        ...
        <button className="hero-connect-btn"  style={{padding: '0.5rem 1.9rem', fontSize: '1.2rem'}}>Connect Portfolio</button>
      </div>
    </div>
  );
}